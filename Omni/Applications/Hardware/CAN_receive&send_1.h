...
float test0;
float test1;	
}board_communication_data;


extern board_communication_data board_communication_data_0;
extern board_communication_data board_communication_data_1;


void get_measure(board_communication_data *ptr, uint8_t data[]);
void CAN1_send_board_data();
board_communication_data get_board_communication();
